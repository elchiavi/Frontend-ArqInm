...
import { ModalCloneFunctionalUnitComponent } from './components/modal-clone-functional-unit/modal-clone-functional-unit.component';
...
const COMPONENTS = [
  ...
  ModalCloneFunctionalUnitComponent,
];
